...
public class AccueilElitController implements Initializable {
    ...
    @FXML
    private void gotToClassromm(ActionEvent event) {
         FXMLLoader loader = new FXMLLoader(getClass().getResource("ClassroomMenu.fxml"));
        try {
            Parent root = loader.load();
            btnClub.getScene().setRoot(root);
        } catch (IOException ex) {
    ...
    @FXML
    private void gotToEquipment(ActionEvent event) {
         FXMLLoader loader = new FXMLLoader(getClass().getResource("EquipmentMenu.fxml"));
        try {
            Parent root = loader.load();
            btnClub.getScene().setRoot(root);
        } catch (IOException ex) {
    ...
    @FXML
    private void goToClass(ActionEvent event) {
